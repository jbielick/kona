  ...
  mountBaseModules: function () {
    ...
    Object.defineProperty(this, 'Controller', {
      ...
      value: {
        ...
        Abstract: require('./controller/abstract')
      }
    });

    Object.defineProperty(this.Controller, 'Base', {
      get: function() {
        console.log([
          'kona.Controller.Base has been deprecated. Please use',
          'kona.Controller.Request for request controller extension.'
        ].join(' '));
        return this.Request;
      }
    })
